 ...
 * @param isHigher If the keypad is connected to the higher 8 pins of the port.
 */
 ...
 * @return The key that is currently pressed. If no key is pressed, 0xFF is returned.
 */
